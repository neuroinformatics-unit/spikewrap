...
class Data(UserDict):
    def __init__(self, base_path, sub_name, run_name, pp_steps):
        super(Data, self).__init__({})  # TODO: is this necssary
        ...
        self.opts = {"0-raw": None}  # TODO: sanity check for testing, is set in a extra loop
    ...
    def set_sorter_output_paths(self, sorter):
        ...
        self.sorter_run_output_path = self.sorter_base_output_path / "sorter_output"  # this is where SI automatically saves sorter output
